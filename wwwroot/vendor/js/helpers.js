    ...
    return function() {
        ...
        var f = {
                        ...
                        if (!0 === e) {
                            var l = function e() {
                                var n = +new Date - u
                                  , i = o(n, s, a, t);
                                r.scrollTop = i,
                                n < t ? requestAnimationFrame(e) : r.scrollTop = a
                            };
                            l()
                        } else
                            r.scrollTop = a
            ...
            _updateInlineStyle: function() {
                ...
                var n = c.replace(/\{navbarHeight\}/gi, e).replace(/\{footerHeight\}/gi, t);
            ...
            scrollPageTo: function(e) {
                ...
                "number" != typeof e && (e = e.getBoundingClientRect().top + i.scrollTop);
                var o = i.scrollTop
                  , r = e - o
                  , s = +new Date
                  , a = function a() {
                    var u = +new Date - s
                      , l = n(u, o, r, t);
                    i.scrollTop = l,
                    u < t ? requestAnimationFrame(a) : i.scrollTop = e
                };
                a()
            },
            setCollapsed: function() {
                var e = this
                  , t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("collapsed")
            ...
            setPosition: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("fixed")
                  , t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d("offcanvas");
            ...
            setFlipped: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("reversed");
            ...
            setAutoUpdate: function() {
                var e = this
                  , t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("enable");
            ...
            on: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("event")
                  , t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d("callback")
                  , o = e.split(".")
                  , r = i(o, 1)
                  , s = r[0]
                  , a = e.split(".")
            ...
            off: function() {
                var e = this
                  , t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("event")
                  , o = t.split(".")
                  , r = i(o, 1)
                  , s = r[0]
                  , a = t.split(".")
        ...
        return "undefined" != typeof window && (f.init(),
        f.isMobileDevice() && window.chrome && document.documentElement.classList.add("layout-menu-100vh"),
        "complete" === document.readyState ? f.update() : document.addEventListener("DOMContentLoaded", (function e() {
            f.update(),
